...
- The separation-of-duties floor was registered as module logic by [2026-06-15-identity-auth.md](2026-06-15-identity-auth.md) and built in `operator-auth-foundation` / `catalog-lifecycle-approval` / `parties-producer-lifecycle`.
