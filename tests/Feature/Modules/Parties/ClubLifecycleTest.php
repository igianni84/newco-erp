...
/**
 * Pins the Club supply-side lifecycle (parties-producer-lifecycle; design L1/L2/L4/L6; party-registry —
 * Requirements: Club Lifecycle, Supply-Side Lifecycle Events). This task covers the `active → sunset`
 * transition via {@see SunsetClub} — the SOLE writer of `Club.status` for sunset and the SINGLE writer of the
 * {@see ClubSunset} event (design L6), used both standalone and as the per-Club step of the Producer-retirement
 * cascade (`RetireProducer`, task 3.2). The `sunset → closed` half (CloseClub) arrives in task 2.2.
 *
