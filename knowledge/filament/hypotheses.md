...
(None yet — Filament patterns accrue in `knowledge.md` until they earn a mechanism and a confirmation count; the established operator-console recipe already lives in `rules.md`.)
