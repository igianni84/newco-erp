...
- **Active next: RM-01 🔴** — GDPR erasure/anonymisation + Address entity (Module K); Round 2 P0-floor headline, size L, ADR "—". Prep via `/spec-to-change`. Alt floor item: RM-02 (enhanced-KYC threshold, M).
