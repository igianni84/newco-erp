 ...
 *
 * A reviewer or approver rejects a Master in `reviewed`: the Master STAYS in `reviewed` (there is no revert
 ...
 * `system`/null actor cannot reject) and from-state guarded (a reject on a non-`reviewed` Master throws
