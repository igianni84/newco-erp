 ...
 *
 * A reviewer or approver rejects a Format in `reviewed`: the Format STAYS in `reviewed` (there is no revert to
 ...
 * reject) and from-state guarded (a reject on a non-`reviewed` Format throws {@see IllegalLifecycleTransition}
 * and writes nothing). A thin per-entity wrapper — the entity label `Format` matches the domain-event
