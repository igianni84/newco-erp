...
/**
 * Rejects a Product Reference under review (§ 4.3) through the shared {@see LifecycleTransition} mechanism
 * (catalog-lifecycle-approval task 4.4; design D5; product-catalog — Requirement: Approval Governance).
 *
...
class RejectProductReferenceReview
{
     ...
     */
    public function handle(ProductReference $reference, string $notes): ProductReference
    {
        return $this->lifecycle->reject($reference, 'ProductReference', $notes);
    }
}
