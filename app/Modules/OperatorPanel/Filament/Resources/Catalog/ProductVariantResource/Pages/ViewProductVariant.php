...
class ViewProductVariant extends OperatorConsoleViewRecord
{
     ...
     * `reviewed → reviewed` audit-only decision this page SURFACES via {@see ResubmitProductVariantForReview} (never an
     ...
     * block-gate itself needs no console code: an activation attempt on a review-stale Product Variant throws
