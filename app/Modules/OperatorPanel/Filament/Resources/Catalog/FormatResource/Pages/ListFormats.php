...
/**
 * The read Format list (operator-console-catalog-spine, task 2.1; design L1/L2).
 *
 ...
 * action renders as a link: no modal, no model write — creation routes through {@see CreateFormat}.
 */
class ListFormats extends ListRecords
{
    ...
    protected function getHeaderActions(): array
    {
        return [
            Action::make('create')
                ->label((string) __('operator_console.format.actions.create'))
                ->url(FormatResource::getUrl('create')),
        ];
    }
}
