 ...
 * deliberately NO Edit page and NO Delete/Create default action. The reason is twofold, and only half of it is
 * about the backend: the Catalog backend ships no update Action FOR THIS ENTITY
...
class FormatResource extends OperatorConsoleResource
{
     ...
     * action in {@see Pages\CreateFormat::createViaAction()} (there is no Edit page — the Catalog backend
     * ships no update Action for this entity, and the edits that DO exist elsewhere in Module 0 are modal
     * header actions on their View page, never Edit pages). All labels localized (invariant 12).
     */
