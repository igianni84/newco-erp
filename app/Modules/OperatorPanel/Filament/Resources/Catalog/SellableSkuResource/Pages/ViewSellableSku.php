...
class ViewSellableSku extends OperatorConsoleViewRecord
{
     ...
     * `reviewed → reviewed` audit-only decision this page SURFACES via {@see ResubmitSellableSkuForReview} (never an
     ...
     * block-gate itself needs no console code: an activation attempt on a review-stale Sellable SKU throws
