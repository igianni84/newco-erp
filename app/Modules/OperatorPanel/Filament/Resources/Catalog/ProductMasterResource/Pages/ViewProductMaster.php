...
/**
 * The read-only Product Master view, plus the review-and-approval lifecycle ACTIONS that operate on the
 * viewed Master (operator-console-catalog-master, tasks 2.1/4.1; design L1/L2/L5/L8; ADR 2026-06-19;
 * spec — Operator advances a Product Master through the review-and-approval lifecycle).
 *
