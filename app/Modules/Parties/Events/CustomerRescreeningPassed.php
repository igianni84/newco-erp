...
/**
 * `CustomerRescreeningPassed` — recorded when a Customer's RE-SCREEN (any screening whose `trigger_source` is NOT
 * `onboarding` — the 12-month cadence, an AML-threshold trigger, or an operator ad-hoc re-screen) completes with a
 * `passed` verdict (parties-compliance, design L3/L4; party-registry — Requirement: Sanctions Screening Events).
 * The verbatim § 15.6 event name; one of the four sanctions screening events this slice records — the ONLY
